    ...
    Win32::{
        ...
        System::{
            Diagnostics::Etw::{
                ...
                EVENT_TRACE_ADDTO_TRIAGE_DUMP, EVENT_TRACE_ADD_HEADER_MODE,
                EVENT_TRACE_BUFFERING_MODE, EVENT_TRACE_CONTROL_STOP,
                EVENT_TRACE_DELAY_OPEN_FILE_MODE, EVENT_TRACE_FILE_MODE_APPEND,
                EVENT_TRACE_FILE_MODE_CIRCULAR, EVENT_TRACE_FILE_MODE_NEWFILE,
                EVENT_TRACE_FILE_MODE_NONE, EVENT_TRACE_FILE_MODE_PREALLOCATE,
                EVENT_TRACE_FILE_MODE_SEQUENTIAL, EVENT_TRACE_INDEPENDENT_SESSION_MODE,
                EVENT_TRACE_MODE_RESERVED, EVENT_TRACE_NONSTOPPABLE_MODE,
                EVENT_TRACE_NO_PER_PROCESSOR_BUFFERING, EVENT_TRACE_PERSIST_ON_HYBRID_SHUTDOWN,
                EVENT_TRACE_PRIVATE_IN_PROC, EVENT_TRACE_PRIVATE_LOGGER_MODE,
                EVENT_TRACE_PROPERTIES, EVENT_TRACE_PROPERTIES_V2, EVENT_TRACE_REAL_TIME_MODE,
                EVENT_TRACE_RELOG_MODE, EVENT_TRACE_STOP_ON_HYBRID_SHUTDOWN,
                EVENT_TRACE_SYSTEM_LOGGER_MODE, EVENT_TRACE_USE_GLOBAL_SEQUENCE,
                EVENT_TRACE_USE_KBYTES_FOR_SIZE, EVENT_TRACE_USE_LOCAL_SEQUENCE,
                EVENT_TRACE_USE_PAGED_MEMORY, WNODE_FLAG_ALL_DATA, WNODE_FLAG_ANSI_INSTANCENAMES,
                WNODE_FLAG_EVENT_ITEM, WNODE_FLAG_EVENT_REFERENCE, WNODE_FLAG_FIXED_INSTANCE_SIZE,
                WNODE_FLAG_INSTANCES_SAME, WNODE_FLAG_INTERNAL, WNODE_FLAG_LOG_WNODE,
                WNODE_FLAG_METHOD_ITEM, WNODE_FLAG_NO_HEADER, WNODE_FLAG_PDO_INSTANCE_NAMES,
                WNODE_FLAG_PERSIST_EVENT, WNODE_FLAG_SEND_DATA_BLOCK, WNODE_FLAG_SEVERITY_MASK,
                WNODE_FLAG_SINGLE_INSTANCE, WNODE_FLAG_SINGLE_ITEM,
                WNODE_FLAG_STATIC_INSTANCE_NAMES, WNODE_FLAG_TOO_SMALL, WNODE_FLAG_TRACED_GUID,
